...
const DRAFT_KEY = "draft_comcast_business_v1";
const PLANS = [
  { title: "Business Internet Essential", price: 70, bestFor: "~4 devices" },
  { title: "Business Internet Standard", price: 90, bestFor: "~5 devices" },
  { title: "Business Internet Performance", price: 110, bestFor: "~8 devices" },
  { title: "Business Internet Advanced", price: 150, bestFor: "~11 devices" },
  {
    title: "Business Internet Gigabit Extra",
    price: 200,
    bestFor: "Unlimited devices",
  },
];
...
export default function ComcastBusinessCheckout() {
  ...
  const price = useMemo(() => {
    ...
    let m = p + (opt.voiceSeats || 0) * 20 + (opt.telAddon || 0) * 20;
    ...
    <div className="max-w-5xl mx-auto p-6" data-aos="fade-up">
      ...
      {step === 1 && (
        <section className="grid gap-6 lg:grid-cols-[1fr_320px]">
          <Card title="Plan & Device Profile">
            <div className="space-y-3">
              {PLANS.map((p) => (
                <RadioRow
                  key={p.title}
                  title={`${p.title} — ${p.bestFor}`}
            ...
            <div className="mt-6 grid gap-3 md:grid-cols-2">
              ...
              <NumberRow
                ...
                value={opt.telAddon}
                onChange={(n) => setOpt({ ...opt, telAddon: n })}
              />
            </div>
          </Card>
          <Summary
        ...
        <section className="grid gap-6 lg:grid-cols-[1fr_320px]">
          <Card title="Review">
            <ul className="text-sm space-y-1">
              ...
              <li>
                <b>Telephone add-on:</b> {opt.telAddon}
              </li>
            </ul>
          </Card>
